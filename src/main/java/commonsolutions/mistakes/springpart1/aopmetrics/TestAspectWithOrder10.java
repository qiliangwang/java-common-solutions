...
public class TestAspectWithOrder10 {
    ...
    @Before("execution(* commonsolutions.mistakes.springpart1.aopmetrics.TestController.*(..))")
    public void before(JoinPoint joinPoint) throws Throwable {
        log.info("TestAspectWithOrder10 @Before");
    }

    @After("execution(* commonsolutions.mistakes.springpart1.aopmetrics.TestController.*(..))")
    public void after(JoinPoint joinPoint) throws Throwable {
        log.info("TestAspectWithOrder10 @After");
    }

    @Around("execution(* commonsolutions.mistakes.springpart1.aopmetrics.TestController.*(..))")
